#ifndef PRIME_WATCH_DUMP_CPLAYERSTATE_HPP
#define PRIME_WATCH_DUMP_CPLAYERSTATE_HPP
...
public:
    ...
    CHealthInfo healthInfo = CHealthInfo(ptr(), 0xC);
...
#endif //PRIME_WATCH_DUMP_CPLAYERSTATE_HPP
